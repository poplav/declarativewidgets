...
package object declarativewidgets {
  ...
  def explore(df: Any, channel: String = "default", properties: Map[String, Any] = Map(), bindings: Map[String, String] = Map(), displayCode: Boolean = false): Unit = {
    util.Explore.explore(df, channel, properties, bindings, displayCode)
  }
}
